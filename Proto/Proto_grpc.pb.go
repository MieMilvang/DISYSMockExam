...
type ProtoServiceClient interface {
	...
	Increment(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*Value, error)
}
...
func (c *protoServiceClient) Increment(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*Value, error) {
	out := new(Value)
	err := c.cc.Invoke(ctx, "/Proto.ProtoService/Increment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProtoServiceServer interface {
	...
	Increment(context.Context, *SetRequest) (*Value, error)
...
func (UnimplementedProtoServiceServer) Increment(context.Context, *SetRequest) (*Value, error) {
...
func _ProtoService_Increment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProtoServiceServer).Increment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Proto.ProtoService/Increment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProtoServiceServer).Increment(ctx, req.(*SetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProtoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProtoService_Increment_Handler,
		},
	},
